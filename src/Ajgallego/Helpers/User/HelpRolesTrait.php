...
trait HelpRolesTrait
{
    ...
    {
        return $this->belongsToMany('\Role', 'help_assigned_roles');
        //return $this->belongsToMany(Config::get('helpers::role'), Config::get('helpers::assigned_roles_table'));
    }
