...
use Ajgallego\Helpers\User\HelpUserModel;
...
class HelpRoleModel extends Ardent
{
    ...
    {
        return $this->belongsToMany('\Ajgallego\Helpers\User\HelpUserModel', 'assigned_roles', 'role_id', 'user_id');
    }
    ...
    {
        return $this->belongsToMany('\Ajgallego\Helpers\User\HelpPermissionModel', 'permission_role', 'role_id', 'permission_id');
    }
